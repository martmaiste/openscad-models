...
<table style="width: 100%; border-collapse: collapse;">
  ...
  <div style="margin-top: 12px; font-size: 14px; word-wrap: break-word;">Spacer</div>
      ...
      <td style="width: 33%; vertical-align: top;"><div style="text-align: center; padding: 10px;">
  <a href="Spacer">
    <img src="Spacer/test.png" alt="test" style="width: 250px; height: 250px; object-fit: cover; border-radius: 12px; display: block; margin: 0 auto;">
  </a>
  <div style="margin-top: 12px; font-size: 14px; word-wrap: break-word;">test</div>
</div>
</td>
    </tr>
    <tr>
