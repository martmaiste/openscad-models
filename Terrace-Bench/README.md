...
## Design Highlights
- **Wall-to-Wall Precision**: Fully parametric to any width (default 2720mm, adjusted for molding).
...
- `clearance_height`: Space underneath for boxes (default `530`, leaving 480mm below the 50mm front reinforcement beam).
...
- `toekick_height`: Vertical start of the support slope (default `350`).
- `toekick_angle`: Matches the IKEA Sortera slope (default `22` degrees).
